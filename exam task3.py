...
query_6 = """
INSERT INTO PublishingHouses (name, city, address) VALUES ('Super Books', 'Wilderness', '120 Main Road');
"""
...
query_8 = """
SELECT * FROM Readers WHERE id IN (SELECT reader_id FROM Readers_Books);
"""
